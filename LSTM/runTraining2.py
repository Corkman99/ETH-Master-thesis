...
result_dir = '/home/mfroelich/Thesis/LSTM_final_param_validation/'

forecast_steps = 8
lr = 0.000002 # 0.00001 should be 2e-6
batch_size = 1
max_epochs = 15
patience = 3

param_hidden = [48,64,88]
param_l2 = [0,1e-6,1e-4]
...
if __name__ == "__main__":
    ...
    test_dataset = TX1day_val(test_dir, forecast_steps = forecast_steps, year_subset = year_range, location_subset = location_subset, scalers=train_dataset.scalers)
    examples = TX1day_val(train_dir, forecast_steps = forecast_steps, year_subset = [1996], location_subset = location_subset, scalers =train_dataset.scalers)
